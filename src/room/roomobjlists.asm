...
;==================================================== SECOND FLOOR =======================================================
    ...
    ..33: {
        dw #obj_ptr_openwall,       $0000, $0001,  $0000,   $0000
        dw #obj_ptr_openwall,       $0000, $0001,  $0000,   $8000
        dw #obj_ptr_sewergrate,     $000e, $001a,  $0800,   $0028
        dw $ffff
    }
    ...
    ..37: {
        dw #obj_ptr_openwall,       $0000, $0001,  $0000,   $0000
        dw #obj_ptr_openwall,       $0000, $0001,  $0000,   $8000
        dw #obj_ptr_vent,           $000e, $001a,  $0000,   $0028
        dw $ffff
    }
    ...
    ..3a: {
        ...
        dw #obj_ptr_openwall,       $0000, $0001,  $0000,   $8000
        dw #obj_ptr_openwall,       $0000, $0001,  $0000,   $0000
        dw #obj_ptr_cabinet,        $0016, $0005,  $0800,   $0003
        dw #obj_ptr_table,          $000d, $0011,  $0800,   $0000
        dw #obj_ptr_books,          $000e, $000c,  $0800,   $0003
        dw #obj_ptr_vent,           $0004, $001a,  $0000,   $0028
        dw $ffff
    }
...
;==================================================== THIRD FLOOR =======================================================
    ...
    ..44: {
        ...
        dw #obj_ptr_bigwindow,  $0001, $0005,  $0c00,   $0000   ;2a
    ...
    ..47: {
        dw #obj_ptr_varitable,  $0006, $000b,  $0800,   $0c02
        ;dw #obj_ptr_vent,       $0005, $001a,  $0000,   $0028
        dw #obj_ptr_vent,       $0004, $001a,  $0000,   $0058
        dw #obj_ptr_openwall,   $0001, $0001,  $0000,   $8000
        dw #obj_ptr_openwall,   $0001, $0001,  $0000,   $0000
        dw #obj_ptr_cabinet,    $0017, $0001,  $0800,   $0003
        dw #obj_ptr_cabinet,    $000d, $0001,  $0800,   $0003
        dw $ffff
    }
    ...
    ..48: {
        dw #obj_ptr_openwall,   $0001, $0001,  $0000,   $8000
        dw #obj_ptr_openwall,   $0001, $0001,  $0000,   $0000
        dw #obj_ptr_cabinet,    $0001, $0014,  $0800,   $0002
        dw #obj_ptr_cabinet,    $000d, $0014,  $0800,   $0002
        dw #obj_ptr_solidrect,  $0001, $0001,  $0000,   $030c
        dw #obj_ptr_vent,       $0016, $001a,  $0000,   $0078
        dw $ffff
    }
    ...
    ..49: {
        dw #obj_ptr_openwall,   $0001, $0001,  $0000,   $8000
        dw #obj_ptr_openwall,   $0001, $0001,  $0000,   $0000
        dw #obj_ptr_shelf,      $0008, $0009,  $0800,   $0015
        dw #obj_ptr_books,      $0019, $0004,  $0800,   $0015
        dw #obj_ptr_vent,       $0016, $001a,  $0000,   $0078
        dw #obj_ptr_ozma,       $0010, $0005,  $1000,   $0000
        ;dw #obj_ptr_liftrect,   $0013, $0007,  $0000,   $0101
        dw $ffff
    }

    ..4a: {
        dw #obj_ptr_fireplace,  $0008, $000e,  $1000,   $0000
        dw #obj_ptr_solidrect,  $0000, $0000,  $0000,   $0209
        dw #obj_ptr_candle,     $0009, $000a,  $1000,   $0000
        dw #obj_ptr_candle,     $0014, $000a,  $1000,   $0000
        dw #obj_ptr_vent,       $0004, $001a,  $0000,   $0078
        dw #obj_ptr_vent,       $0018, $001a,  $0000,   $0010
        dw #obj_ptr_openwall,   $0001, $0001,  $0000,   $8000
        dw #obj_ptr_openwall,   $0001, $0001,  $0000,   $0000
        dw $ffff
    }
    ...
    ..4b: {
        ...
        dw #obj_ptr_crate,      $0010, $0014,  $0800,   $0000
        dw #obj_ptr_crate,      $0008, $0014,  $0800,   $0000
        dw $ffff
    }

    ..4c: {
        dw #obj_ptr_bigwindow,  $0003, $0005,  $0c00,   $0000
        dw #obj_ptr_bigwindow,  $0013, $0005,  $0c00,   $0000
        
        dw #obj_ptr_rug,        $000a, $001a,  $0000,   $0000
        dw #obj_ptr_vent,       $0004, $001a,  $0000,   $0020
        dw #obj_ptr_vent,       $0018, $001a,  $0000,   $0020
    ...
    ..50: {
        dw #obj_ptr_vent,       $0011, $001a,  $0000,   $0028
        dw #obj_ptr_vent,       $0007, $001a,  $0000,   $0028
        ;dw #obj_ptr_vent,       $0011, $001a,  $0000,   $0028
        dw $ffff
    }
    ...
    ..51: {
        ...
        dw #obj_ptr_vent,           $000f, $001a,  $0000,   $0013
        dw #obj_ptr_varitable,      $000e, $0005,  $0800,   $0410
        dw $ffff
    }
    ...
    ..52: {
        dw #obj_ptr_openwall,       $0000, $0000,  $0000,   $8000
        dw #obj_ptr_openwall,       $0000, $0000,  $0000,   $0000
        dw #obj_ptr_vent,           $000e, $001a,  $0000,   $0038
        dw #obj_ptr_rug,            $0010, $001a,  $0c00,   $0000
        dw #obj_ptr_varitable,      $0002, $0005,  $0800,   $0510
        dw $ffff
    }
    ...
    ..54: {
        dw #obj_ptr_openwall,       $0000, $0000,  $0000,   $8000 ;30
        dw #obj_ptr_openwall,       $0000, $0000,  $0000,   $0000 ;2e
        dw #obj_ptr_bigwindow,      $0003, $0005,  $0c00,   $0000 ;2c
        dw #obj_ptr_shelf,          $000e, $0013,  $0800,   $0002 ;2b
        dw #obj_ptr_vent,           $0004, $001a,  $0000,   $0053 ;28
...
;==================================================== FIFTH FLOOR =======================================================
    ...
    ..86: {
        ...
        dw #obj_ptr_cabinet,    $0015, $000f,  $0800,   $0003
    ...
    ..8a: {
        ...
        dw #obj_ptr_rug,        $000e, $001a,  $0800,   $0000
        dw $ffff
    }
    ...
    ..93: {
        ...
        dw #obj_ptr_vent,       $0015, $001a,  $0000,   $0018
        dw $ffff
    }
